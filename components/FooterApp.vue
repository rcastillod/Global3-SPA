    ...
    >
      ...
      <div>
        ...
        <div class="info-wrapper mt-4 md:mt-8 flex flex-col gap-2">
          ...
          <NuxtLink to="mailto:info@global3.cl"> info@global3.cl </NuxtLink>
        </div>
      </div>
      <div>
...
.info-wrapper > a,
.info-wrapper li {
  @apply text-white dark:text-primary transition-colors duration-300 ease-in-out hover:text-orange-2;
}
</style>
