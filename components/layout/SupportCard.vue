...
<template>
  <div
    ...
    <div clas="card-inner">
      <div class="card-icon">
        <ElementsImageBlur :src="support.icono" :alt="support.title" :width="70" />
      </div>
      ...
      <ElementsButtonGradient v-if="support.link != ''" class="mt-5 z-20 relative" :link="support.link"
        :target="support.target">
        Descargar
      </ElementsButtonGradient>
    </div>
